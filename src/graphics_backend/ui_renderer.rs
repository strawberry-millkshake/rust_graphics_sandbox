...
impl UiRenderer {
    ...
    pub fn new(device: &wgpu::Device) -> (Self, wgpu::BindGroupLayout) {
        ...
        let globals = Globals { projection: Mat4::IDENTITY.to_cols_array_2d() };
    ...
    pub fn draw<'pass>(&'pass self, pass: &mut wgpu::RenderPass<'pass>, pipeline: &'pass wgpu::RenderPipeline) {
